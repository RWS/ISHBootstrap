    ...
    process {
        ...
        if ($recipeManifest) {
            ...
            if ($major) {
                ...
                if (-not (Test-ISHRequirement -ISH -Major $major -Minor $minor -Build $build -Revision $revision)) {
        ...
        Invoke-ISHManifestEvent -ManifestHash $recipeManifest -EventName "PreRequisite"
        ...
        switch ($PSCmdlet.ParameterSetName) {
            'ApplicationStop' {
                ...
                Invoke-ISHManifestEvent -ManifestHash $recipeManifest -EventName "StopBeforeCore"
                ...
                Invoke-ISHManifestEvent -ManifestHash $recipeManifest -EventName "StopAfterCore"
            ...
            'AfterInstall' {
                ...
                Invoke-ISHManifestEvent -ManifestHash $recipeManifest -EventName "Execute"
                ...
                if (Test-ISHComponent -Name DatabaseUpgrade) {
                    ...
                    Invoke-ISHManifestEvent -ManifestHash $recipeManifest -EventName "DatabaseUpgradeBeforeCore"
                    ...
                    Invoke-ISHManifestEvent -ManifestHash $recipeManifest -EventName "DatabaseUpgradeAfterCore"
                    ...
                    try {
                        ...
                        Invoke-ISHManifestEvent -ManifestHash $recipeManifest -EventName "DatabaseUpdateBeforeCore"
                        ...
                        Invoke-ISHManifestEvent -ManifestHash $recipeManifest -EventName "DatabaseUpdateAfterCore"
                    }
                    finally {
            ...
            'ApplicationStart' {
                ...
                Invoke-ISHManifestEvent -ManifestHash $recipeManifest -EventName "StartBeforeCore"
                ...
                Invoke-ISHManifestEvent -ManifestHash $recipeManifest -EventName "StartAfterCore"
            ...
            'ValidateService' {
                ...
                Invoke-ISHManifestEvent -ManifestHash $recipeManifest -EventName "Validate"
