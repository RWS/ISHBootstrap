...
function Test-ISHCoreConfiguration {
    ...
    process {
        ...
        $hash = @{
            ...
            MetricsDatabase       = -not (([decimal]"$($deployment.SoftwareVersion.Major).$($deployment.SoftwareVersion.Minor)" -ge 15.1) -and (Compare-Object ((Get-ISHDeploymentParameters -Name ishmetricsconnectstring -ValueOnly @ISHDeploymentSplat) -split ";") ($ConfigurationData.Database.MetricsConnectionString -split ";")))
