...
function Test-ISHCoreConfiguration {
    ...
    process {
        ...
        $hash = @{
            ...
            MetricsDatabase       = -not (($deployment.SoftwareVersion.Major -ge 15) -and (Compare-Object ((Get-ISHDeploymentParameters -Name ishmetricsconnectstring -ValueOnly @ISHDeploymentSplat) -split ";") ($ConfigurationData.Database.MetricsConnectionString -split ";")))
