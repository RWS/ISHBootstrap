...
param(
    ...
    [ValidateSet("12.0.3","12.0.4","13.0.0","13.0.1","13.0.2","14.0.0","14.0.1","14.0.2","14.0.3","14.0.4","15.0.0","15.1","15.1.1","15.1.2","15.1.3","15.2")]
    [string]$ISHVersion,
    ...
    [Parameter(Mandatory=$false,ParameterSetName="From FTP")]
    [Parameter(Mandatory=$false,ParameterSetName="From AWS S3")]
    [string]$MetricsConnectionString=$null
)
